...
public class ObjectFactory {
    ...
    private final static QName _Convert_QNAME = new QName("http://ws.projet.org/", "Convert");
    private final static QName _ConvertResponse_QNAME = new QName("http://ws.projet.org/", "ConvertResponse");
    private final static QName _Compte_QNAME = new QName("http://ws.projet.org/", "compte");
    private final static QName _GetCompte_QNAME = new QName("http://ws.projet.org/", "getCompte");
    private final static QName _GetCompteResponse_QNAME = new QName("http://ws.projet.org/", "getCompteResponse");
    private final static QName _ListComptes_QNAME = new QName("http://ws.projet.org/", "listComptes");
    private final static QName _ListComptesResponse_QNAME = new QName("http://ws.projet.org/", "listComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.projet.org/", name = "Convert")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.projet.org/", name = "ConvertResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.projet.org/", name = "compte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.projet.org/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.projet.org/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.projet.org/", name = "listComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.projet.org/", name = "listComptesResponse")
