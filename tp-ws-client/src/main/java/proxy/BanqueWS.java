 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws.projet.org/", wsdlLocation = "http://localhost:3333/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://ws.projet.org/", "BanqueWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:3333/BanqueWS?wsdl");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws.projet.org/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.projet.org/", "BanqueServicePort"), BanqueService.class, features);
    }
